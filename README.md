<div align="center">
  <a href="#" style="display: block; text-align: center;">
    <img 
      ...
      src="https://togp.douxx.tech?owner=douxxtech&repo=terminal-ogp&theme=json-dark-all&cache=false" 
      type="image/svg+xml" 
...
```md
![Terminal GitOpenGraphImage](https://togp.douxx.tech/?owner=YOUR_USERNAME&repo=YOUR_REPO&avatar=false)
```
...
![Error image](https://togp.douxx.tech/svg/error.svg)
